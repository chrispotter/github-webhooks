...
exports.processPayload = function (payload, config, action) {
  if(payload.organization){
    logger.info('Payload is for the organization: %s, with an action of %s', payload.organization, action);
    ...
    logger.info('Payload is for the repository: %s, with an action of %s', payload.repository.full_name, action);
